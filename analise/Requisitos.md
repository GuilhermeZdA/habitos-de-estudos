...
O sistema deverá permitir que o estudante realize login utilizando seu e-mail e senha cadastrados.
**Prioridade:** Alta

**RF03 – Gerenciamento de perfil**  
O sistema deverá permitir que o estudante visualize e altere seus dados pessoais e preferências de estudo.
**Prioridade:** Média

**RF04 – Cadastro de disciplinas**  
O sistema deverá permitir que o estudante cadastre as disciplinas que está estudando.
**Prioridade:** Alta

**RF05 – Cadastro de hábitos de estudo**  
O sistema deverá permitir que o estudante registre hábitos relacionados aos seus estudos, como horário, duração e frequência de estudo.
**Prioridade:** Alta

**RF06 – Criação de metas de estudo**  
O sistema deverá permitir que o estudante estabeleça metas de estudo, definindo objetivos, prazos e períodos de dedicação.
**Prioridade:** Alta
...
**RNF02 – Desempenho**  
O sistema deverá responder às ações do usuário em um tempo adequado, evitando longas esperas durante a utilização.
**Prioridade:** Média

**RNF03 – Segurança**  
O sistema deverá proteger os dados dos usuários, especialmente as informações de login e senha, utilizando mecanismos adequados de segurança.
**Prioridade:** Alta

**RNF04 – Compatibilidade**  
O sistema deverá funcionar corretamente nos principais navegadores e dispositivos compatíveis com a plataforma utilizada.
**Prioridade:** Média
